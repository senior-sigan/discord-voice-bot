...
На лету можно менять AI-модель внутри текущего provider, голос Qwen и режим автоматического участия. Например: «Олег, переключись на gpt-sol модель» или «Олег, смени голос на arthas». AI provider, STT backend и TTS backend меняются в `defaults` после перезапуска.
